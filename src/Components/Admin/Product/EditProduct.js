...
function EditProduct(props)
{
    ...
    const updateProduct = (e) => {
        ...
        formData.append('populor',allcheckbox.populor ? '1':'0');
        ...
        return (
            <div>
                <div className="vh-100 d-flex justify-content-center align-items-center">  
                    ...
                    <h4 className="text-center">Loading Update Products</h4>
                    </div>
                </div>
            </div>
        );   
        ...
        <div className="container-fluid px-4">
            <div className="card mt-4">
                <div className="card-header">
                    <h4>Edit Product 
                        <Link to="/admin/view-product" className="btn btn-dark btn-sm float-end">BACK</Link>
                    </h4>
                </div>
                <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4 form-group mb-3 mt-4">
                                    <div className="form-check">
                                        ...
                                        <input type="checkbox" onChange={handleCheckbox} defaultChecked={allcheckbox.featured === 1 ? true:false} className="form-check-input" name="featured" />
                                    </div>                              
                                </div>
                                <div className="col-md-4 form-group mb-3 mt-4">
                                    <div className="form-check">
                                        <label className="form-check-label">Populor</label>
                                        <input type="checkbox" onChange={handleCheckbox} defaultChecked={allcheckbox.populor === 1 ? true:false} className="form-check-input" name="populor" />
                                    </div>                              
                                </div>
                                <div className="col-md-4 form-group mb-3 mt-4">
                                    <div className="form-check">
                    ...
                    <button type="submit" className="btn btn-dark mt-3 px-4 float-end">Update</button>
                    </form>
                </div>
            </div>
        </div>
