...
const Navbar = () => {
    ...
    return (
            ...
            <Link className="navbar-brand ps-3" to="/admin">HMSHOP</Link>
            ...
            <ul className="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li className="nav-item dropdown">
                    <Link to="#" className="nav-link dropdown-toggle" id="navbarDropdown"  role="button" data-bs-toggle="dropdown" aria-expanded="false"><FaUser/></Link>
